"""Chunked, checkpointed Form C backfill with a hard floor of 2023-01-01."""
...
class Command(BaseCommand):
    help = "Backfill Form C filings in fixed-size day chunks. Will not go before 2023-01-01."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--checkpoint",
            type=str,
            default="/tmp/form_c_backfill.json",
        )
